        ...
        {step === 2 && (
          <div className="flex flex-col gap-4 animate-fade-in-up">
            ...
            <div className="flex gap-3 mt-4">
              <button
                onClick={handleBack}
                className="flex-1 bg-transparent border border-surface-border text-white font-bold py-3 rounded-lg hover:border-white transition-all"
              >
                Back
              </button>
              <button
                onClick={handleNext}
                disabled={
                  !tempDate || !user.birthData.time || !user.birthData.location
                }
        ...
        {step === 3 && (
          <div className="flex flex-col gap-4 animate-fade-in-up">
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10 text-xs text-text-muted/80 leading-relaxed">
              ...
              astrological insights. We utilize AI to interpret your chart. Your
            ...
            <div className="flex items-start gap-3 p-2">
              <input
                ...
                onChange={(e) => {
                  ...
                  updateUser({
                    preferences: { ...user.preferences, marketingConsent: val },
                  });
                }}
                className="mt-1"
              />
